  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">ONLINE SHOPPING</h2>
      ...
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">CUSTOMER POLICES</h2>
        <nav className="list-none mb-10">
          <li>
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Track Order</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/6 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full">
        <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">EXPERIENCE MYNTRA APP ON MOBILE</h2>
        <nav className="list-none mb-10">
        <div className="container pr-10 py-2 mx-auto flex items-center md:flex-row flex-col">
    <div className="flex md:ml-auto md:mr-0 flex-shrink-0 ">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <p className="text-gray-500 text-sm mt-2 md:text-left text-center">Buildings Alyssa,
  ...
  <div className="bg-gray-100">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      <Link href="#"><a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        <Image  src='/myntra.png' alt='logo' height={40} width={90}/>
      </a></Link>
      <p className="text-sm text-gray-500 sm:ml-1 sm:mt-0 mt-4">© 2022 www.myntra.com. All rights reserved.
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@Myntra</a>
      </p>
